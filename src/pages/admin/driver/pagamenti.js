...
export default function AdminDriverPagamentiPage() {
  ...
  return (
    <AccountLayout>
      <Meta title="Pagamenti - Super Admin" />
      <div className="p-6">
        <Card>
          <Card.Header>
            <h1 className="text-2xl font-bold">Pagamenti</h1>
            <p className="text-gray-600 mt-2">Gestisci i pagamenti</p>
          </Card.Header>
          <Card.Body>
            <div className="space-y-4">
              ...
              {effectiveSlug ? (
                <div className="flex flex-col gap-2">
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/driver/pagamenti`}>
                    Apri Pagamenti driver per {effectiveSlug}
                  </Link>
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/sessions`}>
                    Apri Sessioni (per vedere pagamenti legati alle ricariche)
                  </Link>
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/payouts`}>
                    Apri Payouts (rendicontazione)
                  </Link>
                </div>
              ) : (
