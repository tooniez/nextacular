...
export default function AdminDriverStoricoRicarichePage() {
  ...
  return (
    <AccountLayout>
      <Meta title="Storico Ricariche - Super Admin" />
      <div className="p-6">
        <Card>
          <Card.Header>
            <h1 className="text-2xl font-bold">Storico Ricariche</h1>
            <p className="text-gray-600 mt-2">Visualizza lo storico di tutte le ricariche</p>
          </Card.Header>
          <Card.Body>
            <div className="space-y-4">
              ...
              {effectiveSlug ? (
                <div className="flex flex-col gap-2">
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/driver/storico-ricariche`}>
                    Apri Storico Ricariche driver per {effectiveSlug}
                  </Link>
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/sessions`}>
                    Apri Sessioni (storico ricariche)
                  </Link>
                </div>
              ) : (
