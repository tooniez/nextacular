...
export default function AdminDriverRicaricaInCorsoPage() {
  ...
  return (
    <AccountLayout>
      <Meta title="Ricarica in Corso - Super Admin" />
      <div className="p-6">
        <Card>
          <Card.Header>
            <h1 className="text-2xl font-bold">Ricarica in Corso</h1>
            <p className="text-gray-600 mt-2">Visualizza tutte le ricariche in corso</p>
          </Card.Header>
          <Card.Body>
            <div className="space-y-4">
              ...
              {effectiveSlug ? (
                <div className="flex flex-col gap-2">
                  <Link className="text-blue-600 hover:underline" href={`/account/${effectiveSlug}/driver/ricarica-in-corso`}>
                    Apri Ricarica in Corso driver per {effectiveSlug}
                  </Link>
                  <Link className="text-blue-600 hover:underline" href={`/admin/sessions?workspace=${effectiveSlug}&status=CHARGING`}>
                    Apri ricariche in corso (super-admin)
                  </Link>
                </div>
              ) : (
